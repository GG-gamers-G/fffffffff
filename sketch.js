...
function preload(){
  lose = loadSound("win.mp3")
  win = loadSound("lose.mp3")
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(1500,3000),random(100,500),40,40)

    zombie.addImage(zombieImg)
    zombie.scale = 0.15
    zombie.velocityX = random(-8,-3)
    zombie.debug= true
